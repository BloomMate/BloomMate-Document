...
\begin{enumerate}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/vscode.png}
    \label{fig:VScode}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Xcode.png}
    \label{fig:Xcode}
    \caption{Xcode} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/AndroidStudio.png}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Github.png}
    \label{fig:Github}
    \caption{Github} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Figma.png}
    \label{fig:Figma}
    \caption{Figma} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Notion.png}
    \label{fig:Notion}
    \caption{Notion} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Slack.png}
    \label{fig:Slack}
    \caption{Slack} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Overleaf.png}
    \label{fig:Overleaf}
    \caption{Overleaf} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Postman.png}
    \label{fig:Postman}
    \caption{Postman} 
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=.5\columnwidth]{HYU-SE-2023-BloomMate-DOCUMENT/img/Chatgptpng.png}
    \label{fig:ChatGPT}
    \caption{ChatGPT} 
    \end{figure}  
\end{enumerate}
