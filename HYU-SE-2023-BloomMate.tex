...
\noindent BloomMate offers key features in four categories:
\begin{enumerate}
    \item Plant log management: Users can manage logs throughout the entire planting and harvesting process. \\
    \item Easy plant cultivation: Detailed plant information, expert articles, Q\&A, and AI plant diagnosis are provided to help users grow plants easily. \\
    \item Enjoyable plant cultivation: Users can engage in chat functionality with an AI trained on the plants they are growing. \\
    \item Guide appropriate user actions: Generative AI provides customized information and encourages specific actions, such as one-click purchases. \\
\end{enumerate}


\noindent These features aim to alleviate the difficulties users encounter when cultivating plants.\\
\newline
...
\newline
Currently, BloomMate can be downloaded as an APK file for Android via Google Drive. We are confident that BloomMate will enhance the gardening experience with LG Tiiun in LG's Smart Cottage.\\
\end{abstract}
\begin{IEEEkeywords}
Gardening, Generative AI, AI, Automation, Image Classification\\
\end{IEEEkeywords}
\newpage
